...
const (
	...
	buffSize = 4 * 1024
	header   = `// This file was auto-generated by fenec.
`
)

// ConvertDir converts all Fenec files in the directory to Go files.
...
// Convert converts Fenec source code to Go.
...
func IsFenec(name string) bool { return strings.HasSuffix(name, fExt) }
